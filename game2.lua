...
local function gameStart()
    if (fimjogo == false) then
        inimigoAzulLoopTimer = timer.performWithDelay(3000, creatingEnemyBlue, math.random(3))
        inimigoRoxoLoopTimer = timer.performWithDelay(3000, creatingEnemyPurple, math.random(3))
...
function scene:show( event )
	...
	elseif ( phase == "did" ) then
        ...
        updateFrame2()
        gameLoopTimer = timer.performWithDelay(2000, gameStart,0)
